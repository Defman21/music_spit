...
config :music_spit, MusicSpit.Telegram,
  ...
  allowed_chats: System.fetch_env!("TELEGRAM_CHAT_IDS") |> String.split(" ") |> Enum.into(%{}, &({String.to_integer(&1), nil}))
...
config :music_spit, MusicSpit.Updates,
  ...
  polling_period: System.get_env("TELEGRAM_UPDATES_POLLING_PERIOD", "3000") |> String.to_integer(),
  webhook_url: System.get_env("TELEGRAM_UPDATES_WEBHOOK_URL", nil) # todo: not implemented yet
